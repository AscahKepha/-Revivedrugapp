...
import ProfileDetails from './adminprofile/ProfieDetails';
...
const AdminProfile = () => {
  ...
  const displayProfilePicture = imageProfile || userDetails?.profile_picture || user?.profile_picture || `https://ui-avatars.com/api/?name=${encodeURIComponent(userDetails?.userName || user?.userName || 'User')}&background=4ade80&color=fff&size=128`;
